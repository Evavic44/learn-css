...
<ul>
   ...
   <li>A text-editor: <a href="https://code.visualstudio.com/" alt="VS code website" target="_blank">VS Code</a>, <a href="#" alt="Sublime website" target="_blank">Sublime Text</a> or <a href="https://atom.io/" alt="Atom" target="_blank">Atom</a></li>
